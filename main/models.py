...
class Manuscript(models.Model):
    ...
    repositoryOwner = models.ForeignKey(RepositoryOwner,on_delete=models.CASCADE)
    repositoryLocation = models.ForeignKey(RepositoryLocation,on_delete = models.CASCADE)
    def __str__(self):
